...
### **Attack speeds**
- **All**: Same as Netherite ones
  
**Crying Sword** damages **Enderman**, **Endermite** and **Ghast** twice.
...
To craft one, you need 3 **Reinforced Deepslate (check note)**, one **Crying Ingot** and one **Heavy Core**.
...
- Eating a **rotten flesh**, **poisonous potato**, **raw chicken** or a **spider eye**; drains **6** sanity.
...
- Eating **cooked beef**, **porkchop** or **mutton**; regenerates **4** sanity with 60% chance
