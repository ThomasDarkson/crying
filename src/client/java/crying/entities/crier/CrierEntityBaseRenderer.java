...
public abstract class CrierEntityBaseRenderer<T extends CrierEntity, S extends CrierEntityRenderState, M extends CrierEntityModel<S>> extends HumanoidMobRenderer<T, S, M> {
    ...
    protected CrierEntityBaseRenderer(EntityRendererProvider.Context context, M mainModel, M babyMainModel, M armorInnerModel, M armorOuterModel, M babyArmorInnerModel, M babyArmorOuterModel) {
        super(context, mainModel, babyMainModel, 0.75F);
        this.addLayer(new HumanoidArmorLayer(this, armorInnerModel, armorOuterModel, babyArmorInnerModel, babyArmorOuterModel, context.getEquipmentRenderer()));
