...
public class SpinningCryingShieldFeatureRenderer extends FeatureRenderer<CrierEntityRenderState, CrierEntityModel<CrierEntityRenderState>> {
    ...
    @Override
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, CrierEntityRenderState state, float limbAngle, float limbDistance) {
        if (state.shieldHealth > 0) {
            ...
            state2.render(matrices, vertexConsumers, light, OverlayTexture.DEFAULT_UV);
