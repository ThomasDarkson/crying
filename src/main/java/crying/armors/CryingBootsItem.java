...
public class CryingBootsItem extends Item {
    public CryingBootsItem()
    {
        super(new Item.Properties()
            .humanoidArmor(CryingArmor.CRYING_ARMOR_MATERIAL, ArmorType.BOOTS)
            .fireResistant()
            .enchantable(50)
            .setId(ResourceKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(Crying.ID, "crying_boots")))
            .durability(ArmorType.BOOTS.getDurability(591))
        );
