...
public class CryingLoot {
    ...
    private static final Identifier BASTION_BRIDGE = Identifier.withDefaultNamespace("chests/bastion_bridge");

    private static final Identifier RUINED_PORTAL = Identifier.withDefaultNamespace("chests/ruined_portal");

    private static final Identifier REWARD_OMINOUS_RARE = Identifier.withDefaultNamespace("chests/trial_chambers/reward_ominous_rare");

    public static void modifyLootTables() {
        LootTableEvents.MODIFY.register((key, tableBuilder, source, registries) -> {
            if (source.isBuiltin() && BASTION_TREASURE.equals(key.identifier())) {
            ...
            if (source.isBuiltin() && BASTION_BRIDGE.equals(key)) {
                LootPool.Builder poolBuilder = LootPool.lootPool()
            ...
            if (source.isBuiltin() && RUINED_PORTAL.equals(key.identifier())) {
                LootPool.Builder poolBuilder = LootPool.lootPool()
            ...
            if (source.isBuiltin() && REWARD_OMINOUS_RARE.equals(key.identifier())) {
                LootPool.Builder poolBuilder = LootPool.lootPool()
