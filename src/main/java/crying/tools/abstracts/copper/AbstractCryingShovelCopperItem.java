...
public class AbstractCryingShovelCopperItem extends ShovelItem implements OxidizableCryingTool {
    public AbstractCryingShovelCopperItem(int durability, float speed, int enchantable, String id) {
        super(new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, durability, speed, CryingToolItem.SHOVEL_ATTACK_DAMAGE_BONUS, enchantable, CryingTags.CryingTag), 6.5F, -3F, new Item.Properties()
        ...
        ItemGroupEvents.modifyEntriesEvent(CreativeModeTabs.TOOLS_AND_UTILITIES).register((itemGroup) -> itemGroup.addAfter(Items.NETHERITE_SHOVEL, this));
    }
    ...
    public Component getName(ItemStack stack) {
        ...
        if (text != null)
            return text.append(Component.literal(" ")).append(Component.translatable("item.crying.crying_shovel"));
