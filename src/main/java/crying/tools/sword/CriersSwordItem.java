...
public class CriersSwordItem extends AbstractCryingSwordItem {
    public CriersSwordItem() {
        super(OVER_HARDENED_CORE_WITH_EYE_DURABILITY, OVER_HARDENED_CORE_WITH_EYE_ENCHANTABILITY, OVER_HARDENED_CORE_WITH_EYE_SWORD_ATTACK_DAMAGE_BONUS, OVER_HARDENED_CORE_WITH_EYE_ENCHANTABILITY, "criers_sword");
    }
