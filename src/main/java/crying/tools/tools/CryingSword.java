...
public class CryingSword extends Item {
    ...
    public CryingSword() {
        super(new Item.Settings()
            .sword(new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, durability, speed, attackDamageBonus, enchantability, CryingTags.CryingTag), 19F, -2.4F)
